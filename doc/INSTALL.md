...
Creates `target/installer-linux/lens-correct_0.0.2-1_amd64.deb` or `target/installer-osx/lens-correct-1.pkg`, respectively.
...
```bash
sudo apt install target/installer-linux/lens-correct_0.0.2-1_amd64.deb
```
